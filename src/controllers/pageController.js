...
export const newsNotice = (req, res) => res.render("newsNotice")
export const newsStory = (req, res) => res.render("newsStory")
export const newsLetter = (req, res) => res.render("newsLetter")